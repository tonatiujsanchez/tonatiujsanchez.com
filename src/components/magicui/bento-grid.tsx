...
const BentoCard = ({
  ...
  >
    <div>{background}</div>
    <div className="bg-gradient-to-b from-white/10 to-white group-hover:from-white/0 group-hover:to-white/0 dark:from-black/0 dark:to-black z-10 transition-all duration-300 pt-7">
